...
- [x] Add proposal activity records to the planning domain model.
- [x] Replay activity from existing proposal, task modification, hide, and restore events.
- [x] Keep activity derived from events, not separately mutable.
- [x] Add package replay coverage.
