...
import {
  type AppView,
  type ApplyPlanningWorkflowPreferencesInput,
...
export class DesktopAppStore implements AppStoreInternals {
  ...
  async updatePlanningIdea(input: UpdatePlanningIdeaInput): Promise<DesktopAppState> {
    return plans.updatePlanningIdea(this, input);
  }
  ...
  async startPlanningPlan(input: StartPlanningPlanInput): Promise<DesktopAppState> {
    return plans.startPlanningPlan(this, input);
  }

  async proposePlanningPlan(input: ProposePlanningPlanInput): Promise<DesktopAppState> {
    return plans.proposePlanningPlan(this, input);
  }
  ...
  async startPlanningVerify(input: StartPlanningVerifyInput): Promise<DesktopAppState> {
    return plans.startPlanningVerify(this, input);
  }
