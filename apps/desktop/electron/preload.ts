...
contextBridge.exposeInMainWorld("piApp", {
  ...
  updatePlanningPlanStatus: (input: UpdatePlanningPlanStatusInput) =>
    ipcRenderer.invoke(desktopIpc.updatePlanningPlanStatus, input) as Promise<DesktopAppState>,
  ...
  withdrawPlanningChangeProposal: (input: WithdrawPlanningChangeProposalInput) =>
    ipcRenderer.invoke(desktopIpc.withdrawPlanningChangeProposal, input) as Promise<DesktopAppState>,
  updatePlanningChangeProposal: (input: UpdatePlanningChangeProposalInput) =>
    ipcRenderer.invoke(desktopIpc.updatePlanningChangeProposal, input) as Promise<DesktopAppState>,
  ...
  approvePlanningTaskModification: (input: ApprovePlanningTaskModificationInput) =>
    ipcRenderer.invoke(desktopIpc.approvePlanningTaskModification, input) as Promise<DesktopAppState>,
  hidePlanningTask: (input: HidePlanningTaskInput) =>
    ipcRenderer.invoke(desktopIpc.hidePlanningTask, input) as Promise<DesktopAppState>,
  restorePlanningTask: (input: RestorePlanningTaskInput) =>
    ipcRenderer.invoke(desktopIpc.restorePlanningTask, input) as Promise<DesktopAppState>,
  ...
  startPlanningVerify: (input: StartPlanningVerifyInput) =>
    ipcRenderer.invoke(desktopIpc.startPlanningVerify, input) as Promise<DesktopAppState>,
  recordPlanningTaskVerification: (input: RecordPlanningTaskVerificationInput) =>
    ipcRenderer.invoke(desktopIpc.recordPlanningTaskVerification, input) as Promise<DesktopAppState>,
  startPlanningShip: (input: StartPlanningShipInput) =>
    ipcRenderer.invoke(desktopIpc.startPlanningShip, input) as Promise<DesktopAppState>,
  recordPlanningShipSummary: (input: RecordPlanningShipSummaryInput) =>
    ipcRenderer.invoke(desktopIpc.recordPlanningShipSummary, input) as Promise<DesktopAppState>,
  ...
  getFileContent: (workspaceId: string, filePath: string) =>
    ipcRenderer.invoke(desktopIpc.getFileContent, workspaceId, filePath) as Promise<string>,
