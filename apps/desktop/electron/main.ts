...
app.whenReady().then(async () => {
  ...
  ipcMain.handle(desktopIpc.updatePlanningPlanStatus, (_event, input: UpdatePlanningPlanStatusInput) =>
    store.updatePlanningPlanStatus(input),
  );
  ...
  ipcMain.handle(desktopIpc.updatePlanningChangeProposal, (_event, input: UpdatePlanningChangeProposalInput) =>
    store.updatePlanningChangeProposal(input),
  );
  ...
  ipcMain.handle(desktopIpc.startPlanningPlan, (_event, input: StartPlanningPlanInput) =>
    store.startPlanningPlan(input),
  );
  ipcMain.handle(desktopIpc.proposePlanningPlan, (_event, input: ProposePlanningPlanInput) =>
    store.proposePlanningPlan(input),
  );
  ...
  ipcMain.handle(desktopIpc.startPlanningVerify, (_event, input: StartPlanningVerifyInput) =>
    store.startPlanningVerify(input),
  );
